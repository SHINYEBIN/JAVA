...
public class MemberMenu {
	...
	public void mainMenu() {
		while(true) {
			...
			case 7: 
				return;
			default:
				System.out.println("잘못 입력하셨습니다. 다시 입력해주세.");
			}
		}
	}
	...
	public void insertMember() {
		...
		if(m !=null) {
			...
			mc.insertMember(new Member(userId,userPwd,name,age,gender,email)); // 객체 생성
	...
	public void deleteMember() {
		...
		if(m!=null) {
			System.out.println("기본 정보:"+m.information());
			System.out.print("정말 삭제하겠습니까?(y/n)");
			char ch=sc.nextLine().toUpperCase().charAt(0);
			
			if(ch=='Y') { //('Y')로 쓴 이유: 앞에서 toUpperCase로 했기 때문에 대문자로 써야한다. 
